...
console.log("現時点でのEthereum Mainnetハードフォーク予想日時(JST)");
...
web3.eth.getBlockNumber().then(lastBlockNumber => {
  web3.eth.getBlock(lastBlockNumber).then(lastBlock => {
    web3.eth.getBlock(lastBlockNumber - pastNumber1).then(pastBlock => {
      ...
      console.log("直近", pastNumber1, " ブロック生成平均時間: ", blockMiningTime, "秒    の場合:   ", new Date(unixtime_expectation * convert_msec).toLocaleString());
    ...
    web3.eth.getBlock(lastBlockNumber - pastNumber2).then(pastBlock => {
      ...
      const unixtime_expectation = ((hardForkBlockNumber - lastBlockNumber) * blockMiningTime ) + lastBlock.timestamp;
      console.log("直近", pastNumber2, " ブロック生成平均時間: ", blockMiningTime, "秒    の場合:   ", new Date(unixtime_expectation * convert_msec).toLocaleString());
    ...
    web3.eth.getBlock(lastBlockNumber - pastNumber3).then(pastBlock => {
      ...
      const unixtime_expectation = ((hardForkBlockNumber - lastBlockNumber) * blockMiningTime ) + lastBlock.timestamp;
      console.log("直近", pastNumber3, "ブロック生成平均時間: ", blockMiningTime, "秒    の場合:   ", new Date(unixtime_expectation * convert_msec).toLocaleString());
    ...
    console.log("ブロック生成時間 ", blockMiningTime12, " 秒の場合:   ", new Date(unixtime_expectation12 * convert_msec).toLocaleString());
    ...
    console.log("ブロック生成時間 ", blockMiningTime13, " 秒の場合:   ", new Date(unixtime_expectation13 * convert_msec).toLocaleString());
    ...
    console.log("ブロック生成時間 ", blockMiningTime14, " 秒の場合:   ", new Date(unixtime_expectation14 * convert_msec).toLocaleString());
    ...
    console.log("ブロック生成時間 ", blockMiningTime15, " 秒の場合:   ", new Date(unixtime_expectation15 * convert_msec).toLocaleString());
    ...
    console.log("ブロック生成時間 ", blockMiningTime16, " 秒の場合:   ", new Date(unixtime_expectation16 * convert_msec).toLocaleString());
    ...
    console.log("ブロック生成時間 ", blockMiningTime17, " 秒の場合:   ", new Date(unixtime_expectation17 * convert_msec).toLocaleString());
    });
    });
    });
  });
